...
import 'package:map_water/add_location.dart';
import 'dart:ui' as ui;

import 'package:map_water/autoComplet.dart';

Timer? debounce;

class MapAdvance extends ConsumerStatefulWidget {
  static const routeName = "map-screen";
  const MapAdvance({super.key});

  @override
  MapAdvanceState createState() => MapAdvanceState();
}

class MapAdvanceState extends ConsumerState<MapAdvance> {
  ...
  final key = 'AIzaSyCtuAuB4k8RcAKoFBjqSbbGp0Lj19-OZ9Q';
  ...
  _setNearMarker(LatLng point, String label, List types, String status) async {
    ...
    if (types.contains('restaurant') && restaurant) {
      markerIcon =
          await getBytesFromAsset('assets/mapicons/water.png', 85);
    } else if (types.contains('food') && food){
      markerIcon = await getBytesFromAsset('assets/mapicons/water.png', 85);}
    else if (types.contains('school') && school){
      markerIcon = await getBytesFromAsset('assets/mapicons/waters.png', 85);}
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        child: ListView(
          ...
          children: [
            DrawerHeader(
              ...
              child: Center(child: Image.asset("assets/dd.png")),
            ),
            Center(
                child: Text("Filters",
                    style: TextStyle(
      ...
      appBar: AppBar(
        title: const Text("Clean Water Locations"),
        actions: [IconButton(onPressed: (){
          Navigator.of(context).push(MaterialPageRoute(builder: (context) => const AddLocation(),));
                                ...
                                Container(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Container(
                                          width: 105.0,
                                          child: const Text("Clean water is available on this site and easy to access", style: TextStyle(
                                                fontFamily: 'WorkSans',
                                                fontSize: 11.0,
                                                fontWeight: FontWeight.w400),))
                                    ],
      ...
      //     // fabColor: const Color.fromARGB(255, 58, 26, 109),
      //     // fabOpenColor: const Color.fromARGB(255, 0, 4, 247),
      //     // ringDiameter: 250.0,
      //     // ringWidth: 40.0,
      //     // ringColor: const Color.fromARGB(255, 15, 22, 78),
      //     //iconSize: 60.0,
      //     child: [
      //       IconButton(
      //           onPressed: () {},
